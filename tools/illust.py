...
ILLUST = {
    ...
    'btob-marketing': svg(
        ...
        + '<path d="M71 95h18M141 95h18M211 95h18"/><path d="M84 89l6 6-6 6M154 89l6 6-6 6M224 89l6 6-6 6"/>'
        + ''.join(t(x, 100, s, 13) for x, s in ((45, '検索'), (115, '比較'), (185, '相談'), (255, '発注')))
        + f'<rect x="20" y="150" width="260" height="44" rx="10" stroke="{G}"/>'
        + t(150, 177, '担当者が社内で説明しやすい情報を、段階ごとに用意', 12, weight=500),
        '検索から発注までの流れの図'),
    # 検索 → 記事 → 問い合わせ
    'seo-consulting': svg(
